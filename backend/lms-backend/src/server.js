...
// Railway (and most hosting platforms) sit the app behind a reverse proxy,
// which sets X-Forwarded-For. Express needs to be told to trust exactly one
// hop of proxy so express-rate-limit can read the real client IP safely
